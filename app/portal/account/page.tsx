          ...
          <section className="space-y-6">
            <div className="rounded-[2rem] border border-zinc-200 bg-white p-8 shadow-[0_25px_80px_rgba(15,23,42,0.05)]">
              ...
              <p className="mt-4 max-w-3xl text-zinc-500 leading-8">
                Overzicht van jouw actieve portalaccount en huidige
                toegangsgegevens.
              </p>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="rounded-[2rem] border border-zinc-200 bg-white p-6 shadow-[0_25px_80px_rgba(15,23,42,0.05)]">
                ...
                <p className="mt-2 text-sm text-zinc-500">
                  Deze gebruiker heeft momenteel toegang tot het portaal.
                </p>
              </div>
              ...
              <div className="rounded-[2rem] border border-zinc-200 bg-white p-6 shadow-[0_25px_80px_rgba(15,23,42,0.05)]">
                ...
                <p className="mt-3 text-xl font-semibold text-black">Actief</p>
                <p className="mt-2 text-sm text-zinc-500">
                  Versleutelde sessie actief binnen de portalomgeving.
                </p>
              </div>
            </div>
          </section>
