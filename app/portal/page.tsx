...
export default function PortalDashboardPage() {
  ...
  useEffect(() => {
    ...
    const loadPortal = async () => {
      ...
      if (leadsError) {
        console.log("Supabase fout:", leadsError);
        setLeads([]);
        setLoading(false);
        return;
      }
  ...
  if (sessionLoading) {
    return (
      <main className="min-h-screen bg-[#edf2f7] px-6 py-10 md:px-8">
        <div className="mx-auto max-w-7xl rounded-[2rem] border border-zinc-200 bg-white p-10 shadow-[0_20px_60px_rgba(0,0,0,0.04)]">
          ...
          <div className="flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm leading-7 text-zinc-500 md:text-base">
                  Centrale omgeving voor leadbeheer, exports en beveiligde
                  accounttoegang binnen een afgeschermde portal-omgeving.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
              <div className="rounded-2xl border border-green-200 bg-gradient-to-r from-green-50 to-emerald-50 px-5 py-4 shadow-sm">
                <div className="flex items-center gap-3">
                  <span className="flex h-3 w-3 rounded-full bg-green-500 shadow-[0_0_0_4px_rgba(34,197,94,0.15)]" />
                  <div>
        ...
        <div className="grid items-start gap-6 lg:grid-cols-[290px_minmax(0,1fr)]">
            ...
            <div className="mb-6 overflow-hidden rounded-[1.5rem] border border-zinc-200 bg-gradient-to-br from-[#f8fafc] to-white p-5">
              ...
              <div className="mt-5 rounded-2xl border border-zinc-200 bg-white p-4">
                ...
                <p className="mt-2 text-sm font-semibold text-black">
                  Sessiebeveiliging actief
                </p>
                <p className="mt-1 text-sm text-zinc-500">
                  Toegang via geauthenticeerde omgeving
                </p>
              </div>
            </div>
          ...
          <section className="space-y-6">
            <div className="overflow-hidden rounded-[2rem] border border-zinc-200 bg-white shadow-[0_25px_80px_rgba(15,23,42,0.05)]">
              <div className="border-b border-zinc-200 bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] p-8">
                ...
                <div className="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
                  <div>
                    ...
                    <p className="mt-4 max-w-3xl text-zinc-500 leading-8">
                      Beheer jouw leads vanuit een professioneel ingericht
                      klantportaal met beveiligde toegang, gestructureerde
                      selectie en directe exportmogelijkheden voor opvolging.
                    </p>
                  </div>
                </div>
            ...
            <div className="rounded-[2rem] border border-zinc-200 bg-white p-6 shadow-[0_25px_80px_rgba(15,23,42,0.05)]">
              <div className="grid gap-4 md:grid-cols-3">
                ...
                <InfoStatCard
                  ...
                  subtext="Actieve selectie"
                />

                <InfoStatCard
                  title="Getoond"
                  value={String(stats.showing)}
                  subtext={`Van totaal ${stats.total}`}
                />
              </div>
            </div>

            <div className="overflow-hidden rounded-[2rem] border border-zinc-200 bg-white shadow-[0_25px_80px_rgba(15,23,42,0.05)]">
              <div className="flex flex-col gap-3 border-b border-zinc-200 bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] px-6 py-5 md:flex-row md:items-center md:justify-between">
                <div>
                  <p className="text-xs uppercase tracking-[0.22em] text-zinc-500">
                    Leadbeheer
                  </p>
              ...
              {loading ? (
                <div className="px-6 py-10 text-zinc-500">
                  Leads laden vanuit beveiligde omgeving...
                </div>
